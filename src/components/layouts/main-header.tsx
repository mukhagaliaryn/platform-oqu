        ...
        <div className="sticky top-0 z-40 w-full border-b bg-white/70 dark:bg-black/70 backdrop-blur-2xl">
            <div className="w-full max-w-screen-xl mx-auto px-4 py-2 flex items-center justify-between">
                ...
                <nav className="hidden lg:flex">
                    <Link href={"/"}>
                        <Button variant={"ghost"} className="text-muted-foreground">{t("nav.home")}</Button>
                    </Link>
                    <Link href={"/"}>
                        <Button variant={"ghost"} className="text-muted-foreground">{t("nav.platform")}</Button>
                    </Link>
                    <Link href={"/"}>
                        <Button variant={"ghost"} className="text-muted-foreground">{t("nav.courses")}</Button>
                    </Link>
                    <Link href={"/"}>
                        <Button variant={"ghost"} className="text-muted-foreground">{t("nav.news")}</Button>
                    </Link>
                </nav>
                                ...
                                <SheetDescription asChild>
                                    <div className="grid gap-2 pt-4">
                                        <nav className="grid gap-1">
                                            ...
                                            <Link href={"/"}>
                                                <Button variant={"ghost"} className="text-muted-foreground w-full justify-start">{t("nav.platform")}</Button>
                                            </Link>
                                            <Link href={"/"}>
