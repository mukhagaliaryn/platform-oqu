...
export function MainFooter() {
    ...
    return (
        <div className="border-t">
            <div className="w-full max-w-screen-xl mx-auto px-4 py-8 flex flex-wrap items-start justify-between">
                ...
                <div className="grid gap-2">
                    <h1 className="text-base font-semibold ml-4">{t("nav.resources.title")}</h1>
                    <ul>
                        <li>
                            <Link href={"/"}>
                ...
                <div className="grid gap-2">
                    <h1 className="text-base font-semibold ml-4">{t("nav.about.title")}</h1>
                    <ul>
                        <li>
                            <Link href={"/"}>
                ...
                <div className="grid gap-2">
                    <h1 className="text-base font-semibold ml-4">{t("nav.contact.title")}</h1>
                    <ul>
                        <li>
                            <Link href={"/"}>
